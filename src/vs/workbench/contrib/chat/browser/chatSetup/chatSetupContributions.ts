...
import { AICodeActionsHelper, AINewSymbolNamesProvider, SetupAgent } from './chatSetupProviders.js';
...
export class ChatSetupContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerSetupAgents(context: ChatEntitlementContext, controller: Lazy<ChatSetupController>): void {
		...
		const updateRegistration = () => {
			...
			{
				// Void fork: disable built-in Copilot AI code actions in editor code actions menu
				// ("Modify", "Generate", "Fix", "Explain"), while keeping regular language actions.
